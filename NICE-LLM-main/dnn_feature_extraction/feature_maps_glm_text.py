"""
Package all the VisualGLM_text features
...
parser.add_argument('--dnn', default='glm_text1', type=str)
...
file_name = args.dnn + '_feature_maps_training'
...
# Save the downsampled feature maps
file_name = args.dnn + '_feature_maps_test'
np.save(os.path.join(save_dir, file_name), feats)
del feats
