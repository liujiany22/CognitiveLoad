...
class IE():
    ...
    def get_text_data(self):
        train_txt_feature = np.load(self.txt_data_path + self.args.model_text + '_feature_maps_training.npy', allow_pickle=True)
        test_txt_feature = np.load(self.txt_data_path + self.args.model_text + '_feature_maps_test.npy', allow_pickle=True)
