...
result_path = '/home/NICEpp/results/' 
model_idx = 'test_meg'
...
parser.add_argument('--num_sub', default=4, type=int,
...
class channel_attention(nn.Module):
    def __init__(self, sequence_num=200, inter=30):
...
class Proj_eeg(nn.Sequential):
    def __init__(self, embedding_dim=1040, proj_dim=768, drop_proj=0.5):
        super().__init__(
...
class IE():
    def __init__(self, args, nsub):
        ...
        self.start_epoch = 0
        self.eeg_data_path = '/home/Data/Things-MEG1/Preprocessed_data/'
    ...
    def get_eeg_data(self):
        ...
        train_data = np.load(self.eeg_data_path + '/meg_sub-' + format(self.nSub, '02') + '_train.pkl', allow_pickle=True)
        train_data = np.expand_dims(train_data, axis=1)

        test_data = np.load(self.eeg_data_path + '/meg_sub-' + format(self.nSub, '02') + '_test.pkl', allow_pickle=True)
